...
class User:
    ...
    def __init__(self, **kwargs):
        ...
        # Populate profile
        profile_attrs = ['login', 'email', 'secondEmail', 'firstName', 'lastName', 'mobilePhone', 'ackClosedAccounts', 'ackNewBusiness', 'closeReport', 'lastLogin', 'portalAccessGroup', 'reportGroupList']
